...
echo 'mu'
echo $i $c
combine -v4 -M MaxLikelihoodFit HbbHbb_19invfb_mX300_$i\_$c.root --rMin -5 --rMax 5 --saveNormalizations  > HbbHbb_19invfb_mX300_MaxLikelihood$i\_$c.log                      
combine -v4 -M MaxLikelihoodFit HbbHbb_19invfb_mX270_$i\_$c.root --rMin -5 --rMax 5 --saveNormalizations  > HbbHbb_19invfb_mX270_MaxLikelihood$i\_$c.log                      
#combine -v4 -M MaxLikelihoodFit HbbHbb_19invfb_mX350_$i\_$c.root --rMin -5 --rMax 5 --saveNormalizations  > HbbHbb_19invfb_mX350_MaxLikelihood$i\_$c.log
#combine -v4 -M MaxLikelihoodFit HbbHbb_19invfb_mX400_$i\_$c.root --rMin -5 --rMax 5 --saveNormalizations  > HbbHbb_19invfb_mX400_MaxLikelihood$i\_$c.log
#combine -v4 -M MaxLikelihoodFit HbbHbb_19invfb_mX450_$i\_$c.root --rMin -5 --rMax 5 --saveNormalizations  > HbbHbb_19invfb_mX450_MaxLikelihood$i\_$c.log
