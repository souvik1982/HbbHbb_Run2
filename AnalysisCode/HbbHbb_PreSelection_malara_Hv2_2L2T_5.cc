...
double jet_btag_cut_min = jet_btag_cut_L;
...
void HbbHbb_PreSelection_malara_Hv2_2L2T_5(std::string source_dir, std::string dest_dir, std::string sample,
                                         ...
                                         std::string regressionFile="")
{
    ...
    BTagCalibrationReader csv_calib_l_L(BTagEntry::OP_LOOSE,"central",{"up", "down"});
    BTagCalibrationReader csv_calib_c_L(BTagEntry::OP_LOOSE,"central",{"up", "down"});
    BTagCalibrationReader csv_calib_b_L(BTagEntry::OP_LOOSE,"central",{"up", "down"});
    ...
    BTagCalibrationReader csv_calib_b_H(BTagEntry::OP_TIGHT,"central",{"up", "down"});
