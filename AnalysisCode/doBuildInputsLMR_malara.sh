...
echo "done"
echo "root -x -b -l -q PreselectedWithRegression/LMRSelection_chi2/fit_background_malara.c "
echo
root -x -b -l -q /scratch/malara/WorkingArea/HbbHbb_Run2/AnalysisCode/PreselectedWithRegression/LMRSelection_chi2/fit_background_malara.c > $folder/data_bkg.log
