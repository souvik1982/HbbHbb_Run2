...
//   gSystem->Load("../../PDFs/GaussExpPol_cxx.so");
   ...
   gROOT->LoadMacro("../../BackgroundPrediction_Kinematic_Bern_malara_2L2T.c");
       ...
       BackgroundPrediction_Kinematic_Bern_malara(252, 455,3, // plot range
					  ...
					  260, 280,    // range of gaussExp mean
                                          ...
                                          "lin",
                                "/scratch/malara/WorkingArea/IO_file/output_file/DeepCSV2L2T/LMR/Histograms_LMR_chi2_tree_total.root",
                                          "/scratch/malara/WorkingArea/IO_file/output_file/DeepCSV2L2T/LMR");
}
