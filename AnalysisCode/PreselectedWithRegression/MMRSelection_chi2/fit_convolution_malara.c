{
  ...
  gROOT->LoadMacro("/scratch/malara/WorkingArea/HbbHbb_Run2/AnalysisCode/BackgroundPrediction_Kinematic_Convolution_malara.cc");
  BackgroundPrediction_Kinematic_Convolution_malara(350, 1200, 10, // plot range
                                                    450, 1200,    // fit range
