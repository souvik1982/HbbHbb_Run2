...
void clos_QJ()
{
  gStyle->SetOptStat(0);
   ...
   TString fileName = "SingleMuonSkimmed" + runName + ".root";
    ...
    int nJet, Jet_puId[100], HLT_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v, HLT_BIT_HLT_IsoMu24_v;
    float  Jet_pt[100], Jet_eta[100], Jet_btagCSV[100], CSVsorted[100];
...
void PlotHistos( TH1* histos[4], TString name )
{
    ...
    histos[1]->SetLineColor(kBlack);histos[0]->SetMaximum(2.0*histos[0]->GetMaximum());
