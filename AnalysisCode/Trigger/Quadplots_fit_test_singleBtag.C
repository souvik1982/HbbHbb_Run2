...
//    TFile *_file0 = TFile::Open("SingleElectronVBF.root");
    ...
    tree->Draw("Jet_pt[3]"," 1.0001*(HLT_BIT_HLT_QuadJet45_TripleBTagCSV0p67_v && (HLT_BIT_HLT_IsoMu18_v && Alt$(Jet_pt[3],0)>30 && abs(Jet_eta[0])<2.4 && abs(Jet_eta[1])<2.4 && abs(Jet_eta[2])<2.4 && abs(Jet_eta[3])<2.4))","same");
    ...
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    tree->Draw("Jet_btagCSV[aJCidx[0]]"," 1.0001*(HLT_BIT_HLT_QuadJet45_TripleBTagCSV0p67_v && (HLT_BIT_HLT_IsoMu18_v && Alt$(Jet_pt[3],0)>30 && abs(Jet_eta[0])<2.4 && abs(Jet_eta[1])<2.4 && abs(Jet_eta[2])<2.4 && abs(Jet_eta[3])<2.4))","same");
    ...
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    tree->Draw("Jet_eta[0]"," 1.0001*(HLT_BIT_HLT_QuadJet45_TripleBTagCSV0p67_v && (HLT_BIT_HLT_IsoMu18_v && Alt$(Jet_pt[3],0)>30 && abs(Jet_eta[0])<2.4 && abs(Jet_eta[1])<2.4 && abs(Jet_eta[2])<2.4 && abs(Jet_eta[3])<2.4))","same");
