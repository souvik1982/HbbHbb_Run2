...
void BackgroundPrediction_Kinematic_Bern_malara_2L2T(double plot_lo, double plot_hi, double rebin,
...
i*/  
  ...
  */ // RooBernstein bg_pol("bg_pol", "bg_pol", *x, RooArgList(*bg_p4, *bg_p5, *bg_p6));
  ...
  RooRealVar bg_p2("bg_p2", "bg_p2", 160, 300);//310., 600.); ///310., 600. 
...
/*  bg_p3.setConstant(1);
 ...
 TPad *p_1=new TPad("p_1", "p_1", 0, xPad, 1, 1);
  ...
  c_Background->SaveAs((dest_dir+"/"+"BackgroundFit_"+tag+"_Bern.png").c_str());
  c_Background->SaveAs((dest_dir+"/"+"BackgroundFit_"+tag+"_Bern.pdf").c_str());
