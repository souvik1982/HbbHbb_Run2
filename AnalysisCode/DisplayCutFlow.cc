...
void DisplayCutFlow()
{
	...
	int massL[7]={260, 270, 300, 400, 600, 800, 1000};//, 550, 600, 650, 700, 800, 900, 1000, 1100};
TFile *glugluToX260=new TFile("Histograms_Graviton260GeV.root");
TFile *glugluToX270=new TFile("Histograms_Graviton270GeV.root");//DiJetPt_RadionToHH_4b_M-270GeV
TFile *glugluToX300=new TFile("Histograms_Graviton300GeV.root");//DiJetPt_RadionToHH_4b_M-270GeV
TFile *glugluToX400=new TFile("Histograms_Graviton400GeV.root");//DiJetPt_RadionToHH_4b_M-270GeV
