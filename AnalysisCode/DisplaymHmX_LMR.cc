...
void drawRegion(bool isData=false)
{
  ...
  TEllipse *circle3=new TEllipse(mean_H1_mass_, mean_H2_mass_, sigma_H1_mass_*chi_2, sigma_H2_mass_*chi_2, 260., 360.); circle3->SetLineWidth(3); circle3->SetNoEdges(); circle3->SetLineColor(kBlack); circle3->SetFillStyle(0); circle3->Draw();
  ...
  TPaveText *mod2=new TPaveText(mean_H1_mass_+sigma_H1_mass_*chi_2*3.-marg, mean_H2_mass_+marg, mean_H1_mass_+sigma_H1_mass_*chi_2*3.+marg, mean_H2_mass_-marg);
