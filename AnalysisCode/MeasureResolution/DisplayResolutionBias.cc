...
void Display_pT_Resolution(std::vector<TFile*> *v)
{
  ...
  h_jet_pT_res_vs_pT_eta_0_1p4->GetYaxis()->SetTitleOffset(1.);
  h_jet_pT_res_vs_pT_eta_0_1p4->GetYaxis()->SetTitleSize(0.05);
  h_jet_pT_res_vs_pT_eta_0_1p4->GetXaxis()->SetTitleOffset(1.);
  h_jet_pT_res_vs_pT_eta_0_1p4->GetXaxis()->SetTitleSize(0.05);
...
void Display_eta_ResolutionForFile(std::vector<TFile*> *v)
{
  ...
  TF1 *f_MEAN_jet_eta_res_vs_pT=new TF1("f_MEAN_jet_eta_res_vs_pT", "pol0", 40, 700);
  ...
  TF1 *f_RMS_jet_eta_res_vs_pT=new TF1("f_RMS_jet_eta_res_vs_pT", "[0]+[1]/x+[2]/(sqrt(x))", 40, 700);
...
void Display_phi_ResolutionForFile(std::vector<TFile*> *v)
{
  ...
  TF1 *f_MEAN_jet_phi_res_vs_pT=new TF1("f_MEAN_jet_phi_res_vs_pT", "pol0", 40, 700);
  ...
  TF1 *f_RMS_jet_phi_res_vs_pT=new TF1("f_RMS_jet_phi_res_vs_pT", "[0] + [1]/x + [2]/(sqrt(x))", 40, 700);
