...
dir_selection="../../LMR_150"
dest_dir="/scratch/malara/WorkingArea/IO_file/output_file/DeepCSV/LMR_150/fit"
...
echo "done"
echo "root -x -b -l -q PreselectedWithRegression/LMRSelection_chi2_150/"$background_type
echo
root -x -b -l -q /scratch/malara/WorkingArea/HbbHbb_Run2/AnalysisCode/PreselectedWithRegression/LMRSelection_chi2_150/$background_type > $folder/data_bkg.log
