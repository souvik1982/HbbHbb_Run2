...
int Display_SignalFits_malara(std::string dir_preselection="PreselectedWithRegression", std::string _reg = "reg",
...

{
    ...
    for (unsigned int i=0; i<masses.size(); ++i)
    {
        v_zero.push_back(0);
        string width = "";
        if(masses.at(i) =="1000"	|| masses.at(i) =="1200") file_histograms =  "Histograms_BulkGravTohhTohbbhbb_narrow_M-";
        else width = "_narrow"	;
        ...
        //plot_KinFit->GetYaxis()->SetRangeUser(0.01, 100);
...
if (focus) {
    ...
    /*
     ...
     g_sg_p0->Draw("AC*");
     // g_sg_p0->Fit("pol1");
     c_sg_p0->SaveAs(dest_dir+"/"+"SignalSystematics/c_sg_p0.png");
     ...
     g_sg_p1->Draw("AC*");
     // g_sg_p1->Fit("pol1");
     c_sg_p1->SaveAs(dest_dir+"/"+"SignalSystematics/c_sg_p1.png");
     ...
     g_sg_p2->Draw("AC*");
     // g_sg_p2->Fit("pol1");
     c_sg_p2->SaveAs(dest_dir+"/"+"SignalSystematics/c_sg_p2.png");
     ...
     g_sg_p3->Draw("AC*");
     // g_sg_p3->Fit("pol1");
     c_sg_p3->SaveAs(dest_dir+"/"+"SignalSystematics/c_sg_p3.png");
