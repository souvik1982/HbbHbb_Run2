...
void Display_pT_Resolution(std::vector<TFile*> *v)
{
  ...
  TF1 *f2=new TF1("f2", "pol1", 0, 700);
  h_RMS_jet_pT_res_vs_pT_eta_1p4_2p5->Fit(f2, "R");
  
  TCanvas *c_pT_Resolution_eta_0_1p4=new TCanvas("c_pT_Resolution_eta_0_1p4", "c_pT_Resolution_eta_0_1p4", 1400, 700);
  c_pT_Resolution_eta_0_1p4->Divide(2,1);
  ...
  TCanvas *c_pT_Resolution_eta_1p4_2p5=new TCanvas("c_pT_Resolution_eta_1p4_2p5", "c_pT_Resolution_eta_1p4_2p5", 1400, 700);
  c_pT_Resolution_eta_1p4_2p5->Divide(2,1);
...
void DisplayKinFit()
{
  ...
  */
  ...
  g_KinFit_sigma->GetYaxis()->SetLimits(-1.0, 1.0);
  ...
  g_KinFit_sigma->GetYaxis()->SetLimits(-1.0, 1.0);
  g_KinFit_sigma_KinFit->Draw("A* same");
