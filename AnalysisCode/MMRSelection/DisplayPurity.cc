...
void DisplayPurityForFile(TFile *file, float xmin, float xmax, int rebin)
{
  ...
  leg->AddEntry(h_mX_SR_purity4, ("4 matched jets "+ftoa(h_mX_SR_purity4->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->AddEntry(h_mX_SR_purity3, ("3 matched jets "+ftoa(h_mX_SR_purity3->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->AddEntry(h_mX_SR_purity2, ("2 matched jets "+ftoa(h_mX_SR_purity2->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->AddEntry(h_mX_SR_purity1, ("1 matched jets "+ftoa(h_mX_SR_purity1->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->AddEntry(h_mX_SR_purity0, ("0 matched jets "+ftoa(h_mX_SR_purity0->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->AddEntry(h_mX_SR_purity5, ("Multiple jets to same b "+ftoa(h_mX_SR_purity5->GetEntries()*100./h_mX_SR->GetEntries())+"%").c_str());
  leg->Draw();
