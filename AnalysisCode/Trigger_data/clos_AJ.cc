...
void clos_AJ()
{
  gStyle->SetOptStat(0);
   ...
   TString fileName = "SingleMuonSkimmed" + runName + ".root";
    ...
    int nJet, Jet_puId[100], HLT_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT_BIT_HLT_IsoMu24_v, HLT_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v, diHiggs;
...
void FillHistos( TH1 * histos[4], float variable, float sumpt, float pt2, float pt4, float CSV3, int pass_trigger1, int pass_trigger2 )
{
    ...
    float weightT = TurnOnDouble( sumpt, pt2, pt4, CSV3 ); float weightUpT = TurnOnDoubleUp( sumpt, pt2, pt4, CSV3 ); float weightDownT = TurnOnDoubleDown( sumpt, pt2, pt4, CSV3 );
