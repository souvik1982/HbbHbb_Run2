...
double mean_H1_mass_=150;//120;
double sigma_H1_mass_=20;//25;
double mean_H2_mass_=150;//115;
...
void HbbHbb_LMRSelection_chi2_150_malara(std::string type,std::string source_dir, std::string dest_dir, std::string sample, int signal_mass = 300, bool reg = false  )
{
