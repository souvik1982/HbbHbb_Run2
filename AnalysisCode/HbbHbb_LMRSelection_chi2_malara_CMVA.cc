...
void HbbHbb_LMRSelection_chi2_malara_CMVA(std::string type,std::string source_dir, std::string dest_dir, std::string sample, int signal_mass = 300, bool reg = false  )
{
