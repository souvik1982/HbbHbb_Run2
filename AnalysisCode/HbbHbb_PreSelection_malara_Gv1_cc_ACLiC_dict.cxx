...
#define R__DICTIONARY_FILENAME dIscratchdImalaradIWorkingAreadIHbbHbb_Run2dIAnalysisCodedIHbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict
...
#include "/scratch/malara/WorkingArea/HbbHbb_Run2/AnalysisCode/HbbHbb_PreSelection_malara_Gv1.cc"

// Header files passed via #pragma extra_include

namespace {
  void TriggerDictionaryInitialization_HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict_Impl() {
    static const char* headers[] = {
"/scratch/malara/WorkingArea/HbbHbb_Run2/AnalysisCode/HbbHbb_PreSelection_malara_Gv1.cc",
0
    };
...
"HbbHbb_PreSelection_malara_Gv1", payloadCode, "@",
"JetList", payloadCode, "@",
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict() {
  TriggerDictionaryInitialization_HbbHbb_PreSelection_malara_Gv1_cc_ACLiC_dict_Impl();
}
