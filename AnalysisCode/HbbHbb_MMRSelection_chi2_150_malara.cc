...
double mean_H1_mass_=150;// 120 125;
double sigma_H1_mass_=20; //20
double mean_H2_mass_=150;//125;
...
void HbbHbb_MMRSelection_chi2_150_malara(std::string type,std::string source_dir, std::string dest_dir, std::string sample, int signal_mass = 300, bool reg = false  )
{
