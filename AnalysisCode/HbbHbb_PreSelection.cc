                         ...
                         std::string regressionFile="")
{
  ...
  tree->SetBranchAddress("HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v",&trigger_HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v); tree->SetBranchStatus("HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v",1);
  tree->SetBranchAddress("HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v",&trigger_HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v); tree->SetBranchStatus("HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v",1);
  ...
  tree->SetBranchAddress("btagWeightCMVAV2", &(btagWeightsCMVAV2));
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    */		
	...
	hSF->Fill(eventWeight);
        hWeight->Fill(btagWeightsCMVAV2);
	}
