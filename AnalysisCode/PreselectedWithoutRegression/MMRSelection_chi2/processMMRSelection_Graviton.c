{
  ...
  HbbHbb_MMRSelection_chi2("Signal", "RSGravTohhTohbbhbb_narrow_M-1000_13TeV-madgraph");
  HbbHbb_MMRSelection_chi2("Signal", "RSGravTohhTohbbhbb_narrow_M-1200_13TeV-madgraph");
}
