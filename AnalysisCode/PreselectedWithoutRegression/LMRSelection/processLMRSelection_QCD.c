{ 
  ...
  HbbHbb_LMRSelection("QCD", "QCD_HT100to200_Skim");
  HbbHbb_LMRSelection("QCD", "QCD_HT200to300_Skim");
  HbbHbb_LMRSelection("QCD", "QCD_HT300to500_Skim");
  HbbHbb_LMRSelection("QCD", "QCD_HT500to700_Skim");
