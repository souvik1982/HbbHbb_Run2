...
void clos_QJ()
{
  ...
  //
   TString fileName = "TTbarSkimmed" + runName + ".root";
    ...
    int nJet, Jet_puId[100], HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v, HLT2_BIT_HLT_IsoMu24_v, diHiggs;
  ...
  tree->SetBranchAddress("diHiggs", &(diHiggs)); tree->SetBranchStatus("diHiggs", 1);
    ...
    //   float sumpt = Jet_pt[GoodJets[0]]+Jet_pt[GoodJets[1]]+Jet_pt[GoodJets[2]]+Jet_pt[GoodJets[3]];
      ...
      //  if( CSV[2] < 0.6 ) continue;
        ...
        FillHistos( hPt4, pt4, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hCSV, CSV3, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hEta, eta1, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt2, pt2, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt3, pt3, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt5, pt5, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
