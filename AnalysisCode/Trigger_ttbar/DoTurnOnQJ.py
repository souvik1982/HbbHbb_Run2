...
fileName    ="TTbarSkimmed"+runName+".root"
#fileName    ="Signal600"+runName+".root"
...
preselection = "HLT2_BIT_HLT_IsoMu24_v&& Vtype==2 && CMVAVsorted[3]>0.185 && diHiggs"# && LPt_mass > 400"# && && CSVsorted[2]>0.6  LPt_mass < 1200"#85 " # && Jet_puId>=4" #"HLT2_BIT_HLT_IsoMu18_v"
#preselection = "CMVAVsorted[3]>0.185 && diHiggs"# && && CSVsorted[2]>0.6  LPt_mass < 1200"#85 " # && Jet_puId>=4" #"HLT2_BIT_HLT_IsoMu18_v"
...
Nbins           =  35#50
functionMin     =  150#160#120
functionMax     =  500#260#270
var             = "Jet_pt[0]+Jet_pt[1]+Jet_pt[2]+Jet_pt[3]"
...
Nbins       = 20#140#70
functionMin = 20#30#35
functionMax = 80#100#105
var             = "Jet_pt[3]"
...
parametersTurnOn_funct = (100,20,0.01,1)
Nbins       = 10#28#80#24
functionMin = 0.8#0.2#0.4 #CSVL =  0.460 
...
Nbins       = 15#100#50
functionMin = 30#30#40
functionMax = 60#130#140
var             = "Jet_pt[3]"
#var             = "Sum$(Pt4(Jet_pt,Jet_eta,Jet_puId,3,Iteration$,Length$))"
preselection    = preselection + "&&"+ trigger
trigger         = "ntrgObjects_hltQuadPFCentralJetLooseID45>=4"
