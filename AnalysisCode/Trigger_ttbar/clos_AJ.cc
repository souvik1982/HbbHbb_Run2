...
void clos_AJ()
{
  ...
  //  TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/GluGluToBulkGravitonToHHTo4B_M-300_narrow_13TeV-madgraph.root";
  //
   TString fileName = "TTbarSkimmed" + runName + ".root";
    ...
    TH1*hEta[4]; SetHistos(hEta,"hEta",40,-4,4);
    TH1*hPt2[4]; SetHistos(hPt2,"hPt2",25,0,200);
    TH1*hPt3[4]; SetHistos(hPt3,"hPt3",25,0,200);
    TH1*hPt5[4]; SetHistos(hPt5,"hPt5",25,0,200);

    int nJet, Jet_puId[100], HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_IsoMu24_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v, diHiggs;
    ...
    tree->SetBranchAddress("HLT2_BIT_HLT_IsoMu24_v", &(HLT2_BIT_HLT_IsoMu24_v)); tree->SetBranchStatus("HLT2_BIT_HLT_IsoMu24_v", 1);
    tree->SetBranchAddress("Jet_puId", &(Jet_puId)); tree->SetBranchStatus("Jet_puId", 1);
    tree->SetBranchAddress("HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v", &(HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v)); tree->SetBranchStatus("HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v", 1);
    tree->SetBranchAddress("HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v", &(HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v)); tree->SetBranchStatus("HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v", 1);
  ...
  tree->SetBranchAddress("diHiggs", &(diHiggs)); tree->SetBranchStatus("diHiggs", 1);
    ...
    for (int i=0; i<nEvents; ++i)
    {
        ...
        if( ! ( HLT2_BIT_HLT_IsoMu24_v  && Vtype == 2  && diHiggs) ) continue;    
        //if ( !(vType==-1) ) continue;   
    ...
    //    std::sort( Jet_pt, Jet_pt + nJet, std::greater<float>());
       ...
       // if( CSV[3] < 0.8 ) continue;
        ...
        FillHistos( hPt4, pt4, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hCSV, CSV3, sumpt, pt2, pt4, CSV3,HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v  );
        FillHistos( hEta, eta1, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt2, pt2, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt3, pt3, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
        FillHistos( hPt5, pt5, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v );
    }
...
//*/
    weight += TurnOnDouble( sumpt, pt2, pt4, CSV3 ); weightUp += TurnOnDoubleUp( sumpt, pt2, pt4, CSV3 ); weightDown += TurnOnDoubleDown( sumpt, pt2, pt4, CSV3 );//std::cout << weight;
float test = weight;
