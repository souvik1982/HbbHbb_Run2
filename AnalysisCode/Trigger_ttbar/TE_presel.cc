...
void TE_presel()
{
   ...
   // TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/TTJets_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root";   //root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/SingleMuon" + runName + ".root";
// TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/TTJets_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root";
// TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/TTJets_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_"+runName+".root";
     TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/GluGluToBulkGravitonToHHTo4B_M-700_narrow_13TeV-madgraph.root";
  ...
  TFile *outfile=new TFile("Signal700"+runName+".root", "recreate");  
 ...
 /* outtree->Branch("Jet_pt",&Jet_pt,"Jet_pt/F");
  ...
  outtree->Branch("HLT2_BIT_HLT_IsoMu24_v",&HLT2_BIT_HLT_IsoMu24_v,"HLT2_BIT_HLT_IsoMu24_v/i");
  ...
  outtree->Branch("HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v",&HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v,"HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v/i");
  ...
  for (Int_t i=0; i<nEvents; ++i)
  {
      ...
      tree->GetEvent(i);
   //   if( ! ( HLT2_BIT_HLT_IsoMu24_v ) ) continue;
      Int_t counter = 0;
      Int_t GoodJets[100];
    ...
    for (unsigned int j=0; j<counter; ++j)
    {
      ...
      /*  HLT2_BIT_HLT_IsoMu24_v_ = HLT2_BIT_HLT_IsoMu24_v;
        ...
        HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v_ = HLT2_BIT_HLT_QuadJet45_TripleBTagCSV_p087_v;
