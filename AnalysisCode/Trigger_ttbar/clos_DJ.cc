...
//    TString fileName = "root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/GluGluToBulkGravitonToHHTo4B_M-900_narrow_13TeV-madgraph.root";
   TString fileName = "TTbarSkimmed" + runName + ".root";
    ...
    int nJet, Jet_puId[100], HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v, HLT2_BIT_HLT_IsoMu24_v, diHiggs;
  ...
  tree->SetBranchAddress("diHiggs", &(diHiggs)); tree->SetBranchStatus("diHiggs", 1);
    ...
    //   if( CSV[2] < 0.6 ) continue;
      //  if( CSV[3] < 0.8 ) continue;      
        ...
        FillHistos( hPt4, pt4, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v );
        FillHistos( hCSV, CSV3, sumpt, pt2, pt4, CSV3,HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v  );
        FillHistos( hEta, eta1, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v );
        FillHistos( hPt2, pt2, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v );
        FillHistos( hPt3, pt3, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v );
        FillHistos( hPt5, pt5, sumpt, pt2, pt4, CSV3, HLT2_BIT_HLT_DoubleJet90_Double30_TripleBTagCSV_p087_v );
